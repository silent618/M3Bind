...
class CTCLIP(nn.Module):
    ...
    def tokenize(self, prompt):
        text_tokens = self.tokenizer(prompt, return_tensors="pt", padding="max_length", truncation=True,
                                     max_length=512).to(torch.cuda)
        return text_tokens
    ...
    def forward(
        ...
        b, device = text.input_ids.shape[0], image.device
        ...
        return loss, text_latents, image_latents
